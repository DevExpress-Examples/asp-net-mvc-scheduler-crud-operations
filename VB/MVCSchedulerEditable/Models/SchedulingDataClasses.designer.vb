...
'#Region "Extensibility Method Definitions"
        ...
        Partial Private Sub InsertDBAppointment(ByVal instance As MVCSchedulerEditable.Models.DBAppointment)
        End Sub

        Partial Private Sub UpdateDBAppointment(ByVal instance As MVCSchedulerEditable.Models.DBAppointment)
        End Sub

        Partial Private Sub DeleteDBAppointment(ByVal instance As MVCSchedulerEditable.Models.DBAppointment)
        End Sub

        Partial Private Sub InsertDBResource(ByVal instance As MVCSchedulerEditable.Models.DBResource)
        End Sub

        Partial Private Sub UpdateDBResource(ByVal instance As MVCSchedulerEditable.Models.DBResource)
        End Sub

        Partial Private Sub DeleteDBResource(ByVal instance As MVCSchedulerEditable.Models.DBResource)
        End Sub

'#End Region
        Public Sub New()
            MyBase.New(Global.System.Configuration.ConfigurationManager.ConnectionStrings(CStr(("SchedulerCarsConnectionString"))).ConnectionString, MVCSchedulerEditable.Models.SchedulingDataClassesDataContext.mappingSource)
            Me.OnCreated()
        End Sub

        Public Sub New(ByVal connection As String)
            MyBase.New(connection, MVCSchedulerEditable.Models.SchedulingDataClassesDataContext.mappingSource)
            Me.OnCreated()
        End Sub
        ...
        Public ReadOnly Property DBAppointments As System.Data.Linq.Table(Of MVCSchedulerEditable.Models.DBAppointment)
            Get
                Return Me.GetTable(Of MVCSchedulerEditable.Models.DBAppointment)()
            End Get
        End Property

        Public ReadOnly Property DBResources As System.Data.Linq.Table(Of MVCSchedulerEditable.Models.DBResource)
            Get
                Return Me.GetTable(Of MVCSchedulerEditable.Models.DBResource)()
            End Get
        End Property
    End Class
...
'#End Region
        ...
        Protected Overridable Sub SendPropertyChanging()
            RaiseEvent PropertyChanging(Me, MVCSchedulerEditable.Models.DBAppointment.emptyChangingEventArgs)
        End Sub
...
'#End Region
        ...
        Protected Overridable Sub SendPropertyChanging()
            RaiseEvent PropertyChanging(Me, MVCSchedulerEditable.Models.DBResource.emptyChangingEventArgs)
        End Sub
